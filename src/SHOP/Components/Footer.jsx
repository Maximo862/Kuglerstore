...
export function Footer() {
 ...
 <h3>Links</h3>
        ...
        <div className="col-md-2 d-flex flex-column text-align-center">
          <h3>Networks</h3>
          <a href="mailto:Maximokugler9@gmail.com" target="_blank" className="text-white me-3 mb-2">
            <SiGmail size={25} className="footer-icon gmail"/>
          </a>
          <a href="https://www.linkedin.com/in/maximo-kugler-716962379/" target="_blank" className="text-white me-3 mb-2">
            <FaLinkedinIn size={25} className="footer-icon linkedin"/>
          </a>
          <a href="https://github.com/Maximo862" target="_blank" className="text-white mb-2">
